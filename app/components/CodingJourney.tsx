...
export default function CodingJourney() {
  ...
  const second = () =><>In the summer of 2020 I was given the opportunity to work with Genius Plaze through the SMASH-Rising internship. My coworkers and I built a solution to increase civic engament within local communities with the help from the team at Genius Plaza. In the process I was exposed to <strong className='text-red-500'>React Native</strong> and <strong className='text-red-500'>Python</strong>.</>;
